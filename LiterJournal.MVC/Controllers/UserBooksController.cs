...
namespace LiterJournal.MVC.Controllers
{
    public class UserBooksController : Controller
    {
        ...
        {
            var applicationDbContext = _context.UserBooks.Include(u => u.Book).Include(u => u.UserProfile);
        ...
        public IActionResult Create()
        {
            ...
            ViewData["UserProfileId"] = new SelectList(_context.UserProfiles, "Id", "UserId");
            return View();
        }
        ...
        public async Task<IActionResult> Create([Bind("Id,UserProfileId,BookId,AddedDate,Status,Rating,Review")] UserBook userBook)
        {
            ...
            ViewData["UserProfileId"] = new SelectList(_context.UserProfiles, "Id", "UserId", userBook.UserProfileId);
            return View(userBook);
        }
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,UserProfileId,BookId,AddedDate,Status,Rating,Review")] UserBook userBook)
        {
            if (id != userBook.Id)
            {
                return NotFound();
