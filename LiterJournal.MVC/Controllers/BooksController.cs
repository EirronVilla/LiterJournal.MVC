...
namespace LiterJournal.MVC.Controllers
{
    public class BooksController : BaseController
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Title,Author,Genre,ISBN,CoverUrl,PublishedDate")] Book book)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Title,Author,Genre,ISBN,CoverUrl,PublishedDate")] Book book)
        {
            if (id != book.Id)
            {
                return NotFound();
